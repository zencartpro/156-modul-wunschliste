 ...
 * @version $Id: tpl_header.php for Wishlist 2019-08-14 18:49:16Z webchills $
 */
?>
...
<?php if (UN_DB_MODULE_WISHLISTS_ENABLED == 'true') { ?> <li><a href="<?php echo zen_href_link(FILENAME_WISHLIST, '', 'SSL'); ?>"><?php echo UN_HEADER_TITLE_WISHLIST; ?></a></li><?php } ?> 
<?php } ?>
<!--eof wishlist-->
